...
CATEGORY_ROLES: dict[str, list[str]] = {
    ...
    CONF_BATTERY_STORAGES: [CONF_BATTERY_POWER, CONF_BATTERY_SOC, CONF_BATTERY_MODE,CONF_CHARGING_RATE],
...
CATEGORY_COMMAND_TYPES: dict[str, list[str]] = {
    ...
    CONF_BATTERY_STORAGES: [COMMAND_SET_BATTERY_MODE,COMMAND_SET_CHARGING_RATE],
